  ...
  const L = {
    terms: {
      en: { t: 'Terms of Service & Competition Rules', u: U, intro: 'AYILON Arena ("AYILON", "we") runs a global trading competition where participants compete using their own real exchange accounts. By creating an account or joining a competition you agree to these Terms.', sec: [
        { h: '1. Eligibility', li: ['You must be at least 18 and legally permitted to trade crypto derivatives in your jurisdiction.', 'Participation requires a verified email and a connected read-only exchange API key.', 'To be eligible for prizes, your exchange account must (a) be registered through AYILON\'s referral link, and (b) hold at least the published minimum balance at the start of the season.', 'The return (%) category requires a higher minimum balance than the profit and volume categories, so tiny accounts cannot use all-in, high-leverage bets to farm the percentage ranking — keeping it a contest of skill, not luck.'] },
        { h: '2. The competition', li: ['Entry is free. No entry fee, no purchase required.', 'You connect a read-only API key. AYILON reads only equity, profit and volume — we cannot trade, transfer or withdraw.', 'Rankings are computed automatically across three categories (return %, profit, volume) over a monthly season that resets on the 1st at 00:00 UTC.', 'The return % board is ranked by risk-adjusted return — penalized by your worst peak-to-trough drawdown — so a lucky high-leverage gamble cannot outrank a steadier trader.', 'One account per person. Prize eligibility also requires trading on at least the published number of distinct days and meeting the minimum season volume, so prizes reward genuine, sustained trading — not a single all-in bet.', 'Deposits and withdrawals during a season are excluded from performance to keep rankings fair.'] },
        { h: '3. Prizes', li: ['The prize pool is funded from AYILON\'s trading rewards and grows as the league grows. Each prize is a real share of that pool — never more than the funded amount.', 'Prizes go to the top eligible participants in each category at season end. Winning more than one category is allowed.', 'Prizes are paid in USDT on the TRON (TRC20) network only, within 24 hours after the winner submits a valid wallet address. Winners must first complete a short winner interview; prizes are not paid without it.', 'We may adjust the funded percentage, split, categories and schedule, and may withhold prizes where abuse is suspected.'] },
        { h: '4. Fair play & prize forfeiture', p: 'The following cause loss of prize eligibility and forfeiture of any prize; deliberate abuse also causes disqualification and a permanent ban. AYILON\'s determinations on eligibility and fair play are final.', li: [
          'Operating multiple accounts for advantage, or one person controlling several entries.',
          'Opposite-side (long/short) hedging between linked or related accounts.',
          'Wash trading, self-dealing, or otherwise generating artificial volume to farm the volume board.',
          'Market manipulation, or exploiting bugs, the scoring system, or the prize mechanism.',
          'Falsifying or misrepresenting results, or refusing reasonable verification.',
          'Colluding with other participants, or sharing/operating one account across multiple people.',
          'Connecting an OKX account not created through the AYILON referral — such accounts cannot be connected and are never prize-eligible.',
          'Not meeting the published minimums (balance, the higher return-board balance, trading volume, and distinct trading days) — not prize-eligible.',
          'Not completing the required winner interview, or not submitting a valid USDT (TRC20) wallet within the claim window — the prize is forfeited.',
          'Using deposits or withdrawals to manipulate performance metrics.',
          'Being under 18, or participating from a jurisdiction where it is not permitted.'
        ] },
      ...
      ko: { t: '이용약관 & 대회 규정', u: '최종 수정: 2026년 6월 29일', intro: 'AYILON Arena("AYILON", "회사")는 참가자가 자신의 실제 거래소 계정으로 경쟁하는 글로벌 트레이딩 대회를 운영합니다. 계정을 만들거나 대회에 참가하면 본 약관에 동의하는 것으로 간주됩니다.', sec: [
        { h: '1. 참가 자격', li: ['만 18세 이상이며 거주 지역에서 암호화폐 파생상품 거래가 합법적으로 허용되어야 합니다.', '참가에는 이메일 인증과 읽기 전용 거래소 API 키 연결이 필요합니다.', '상금 대상이 되려면 거래소 계정이 (a) AYILON 추천 링크로 가입되어 있고, (b) 시즌 시작 시점에 공지된 최소 잔고 이상을 보유해야 합니다.', '수익률(%) 부문은 수익금·거래량 부문보다 높은 최소 잔고를 요구합니다. 이는 소액 계정이 풀레버리지 몰빵으로 수익률 순위를 차지하는 것을 막아, 이 부문을 운이 아닌 실력의 경쟁으로 유지하기 위함입니다.'] },
        { h: '2. 대회 방식', li: ['참가는 무료입니다. 참가비도, 구매도 필요 없습니다.', '읽기 전용 API 키를 연결합니다. AYILON은 평가금·수익·거래량만 읽으며 매매·이체·출금은 할 수 없습니다.', '순위는 세 부문(수익률·수익금·거래량)으로 매월 1일 00:00 UTC에 초기화되는 월간 시즌 동안 자동 집계됩니다.', '수익률 부문은 위험조정 수익률(시즌 최대 낙폭으로 벌점)로 순위를 매겨, 고레버리지 한탕 도박이 꾸준한 트레이더를 앞설 수 없습니다.', '1인 1계정입니다. 상금 자격에는 공지된 최소 거래일수 이상 거래와 최소 시즌 거래량 충족이 함께 필요하며, 상금은 한 번의 몰빵이 아니라 진짜 꾸준한 거래를 보상합니다.', '시즌 중 입출금은 순위 공정성을 위해 성과에서 제외됩니다.'] },
        { h: '3. 상금', li: ['상금 풀은 AYILON의 거래보상에서 적립되며 리그가 커질수록 함께 커집니다. 각 상금은 실제 풀의 일정 비율이며, 적립된 금액을 절대 초과하지 않습니다.', '상금은 시즌 종료 시 각 부문의 상위 자격 참가자에게 지급됩니다. 여러 부문 동시 우승도 가능합니다.', '상금은 TRON(TRC20) 네트워크의 USDT로만, 우승자가 유효한 지갑 주소를 제출한 후 24시간 이내에 지급됩니다. 우승자는 간단한 우승자 인터뷰를 먼저 작성해야 하며, 작성하지 않으면 상금이 지급되지 않습니다.', '회사는 적립 비율·배분·부문·일정을 조정할 수 있으며, 부정행위가 의심되면 상금을 보류할 수 있습니다.'] },
        { h: '4. 공정성 & 상금 몰수', p: '다음은 상금 자격 상실 및 상금 몰수 사유이며, 고의적 어뷰징은 실격 및 영구 정지 대상입니다. 자격 및 공정성에 대한 AYILON의 판단이 최종입니다.', li: [
          '유리함을 얻기 위한 다중 계정 운영, 또는 한 사람이 여러 참가 계정을 조종하는 행위.',
          '연결되거나 관련된 계정 간의 양방향(롱/숏) 헤지.',
          '워시 트레이딩·자전거래 등 거래량 부문을 노린 인위적 거래량 생성.',
          '시세 조종, 또는 버그·집계 시스템·상금 구조의 악용.',
          '결과 조작·허위 표시, 또는 합리적인 검증 거부.',
          '다른 참가자와의 공모, 또는 한 계정을 여러 사람이 공유·운영하는 행위.',
          'AYILON 추천으로 가입하지 않은 OKX 계정 연결 — 해당 계정은 연결 자체가 차단되며 상금 대상이 아닙니다.',
          '공지된 최소 기준(잔고, 수익률 부문의 상향 잔고, 거래량, 거래일 수) 미달 — 상금 대상 아님.',
          '우승자 인터뷰 미작성, 또는 지급 기한 내 유효한 USDT(TRC20) 지갑 미제출 — 상금 몰수.',
          '입출금을 이용한 성과 지표 조작.',
          '만 18세 미만이거나 참가가 허용되지 않는 지역에서의 참가.'
        ] },
      ...
      zh: { t: '服务条款与赛事规则', u: '最后更新：2026年6月29日', intro: 'AYILON Arena（“AYILON”“我们”）运营一个全球交易赛事，参赛者使用自己的真实交易所账户竞争。创建账户或参赛即表示您同意本条款。', sec: [
        { h: '1. 参赛资格', li: ['您须年满18岁，且在您所在司法辖区可合法交易加密衍生品。', '参赛需验证邮箱并连接只读交易所API密钥。', '若要获得奖金，您的交易所账户须（a）通过AYILON推荐链接注册，且（b）在赛季开始时持有不低于公布的最低余额。', '收益率（%）类别要求的最低余额高于盈利额和交易量类别，以防止小额账户通过满仓高杠杆押注来刷取收益率排名——让其成为实力而非运气的比拼。'] },
        { h: '2. 赛事方式', li: ['免费参赛。无报名费，无需购买。', '连接只读API密钥。AYILON仅读取净值、盈亏和交易量——无法交易、转账或提现。', '排名按三个类别（收益率、盈利额、交易量）在每月1日00:00 UTC重置的月度赛季中自动计算。', '收益率榜按风险调整后收益（以最大回撤扣分）排名，因此高杠杆的运气式豪赌无法超过稳健的交易者。', '每人限一个账户；奖金资格还要求在不少于公布天数的不同日期交易并达到最低赛季交易量——奖金奖励真实持续的交易，而非一次性全仓。', '赛季内的充值与提现将从业绩中排除，以保证排名公平。'] },
        { h: '3. 奖金', li: ['奖池来自AYILON的交易返佣，随联赛成长而增加。每份奖金都是奖池的真实比例份额，绝不超过已注资金额。', '奖金在赛季结束时发给各类别的顶尖合格参赛者。允许同时赢得多个类别。', '奖金仅以 TRON（TRC20）网络的 USDT 发放，在获奖者提交有效钱包地址后 24 小时内支付。获奖者须先完成简短的获奖者访谈，否则不予发放。', '我们可调整注资比例、分配、类别和赛程，并在怀疑作弊时扣发奖金。'] },
        { h: '4. 公平竞赛与奖金没收', p: '以下行为导致丧失奖金资格并没收奖金；故意作弊还将取消资格并永久封禁。AYILON对资格与公平的判定为最终决定。', li: [
          '为获取优势运营多个账户，或一人操控多个参赛账户。',
          '关联或相关账户间的反向（多/空）对冲。',
          '对敲、自成交，或以其他方式制造虚假交易量刷取交易量榜。',
          '市场操纵，或利用漏洞、计分系统或奖金机制。',
          '伪造或谎报结果，或拒绝合理核实。',
          '与其他参赛者串通，或多人共享/操作同一账户。',
          '连接非通过 AYILON 推荐注册的 OKX 账户——此类账户无法连接，且永不具备奖金资格。',
          '未达到公布的最低标准（余额、收益率榜更高的余额、交易量、交易天数）——不具备奖金资格。',
          '未完成获奖者访谈，或未在领取期限内提交有效的 USDT（TRC20）钱包——奖金没收。',
          '利用充值或提现操纵业绩指标。',
          '未满18岁，或在不允许参与的司法辖区参与。'
        ] },
      ...
      es: { t: 'Términos de servicio y reglas del torneo', u: 'Última actualización: 29 de junio de 2026', intro: 'AYILON Arena ("AYILON", "nosotros") organiza un torneo global de trading donde los participantes compiten con sus propias cuentas reales de exchange. Al crear una cuenta o participar, aceptas estos Términos.', sec: [
        { h: '1. Elegibilidad', li: ['Debes tener al menos 18 años y estar legalmente autorizado a operar derivados cripto en tu jurisdicción.', 'La participación requiere un email verificado y una clave API de solo lectura conectada.', 'Para optar a premios, tu cuenta de exchange debe (a) estar registrada mediante el enlace de referido de AYILON y (b) tener al menos el saldo mínimo publicado al inicio de la temporada.', 'La categoría de rentabilidad (%) exige un saldo mínimo mayor que las de beneficio y volumen, para que las cuentas pequeñas no usen apuestas all-in con alto apalancamiento para inflar el ranking porcentual — manteniéndolo una competición de habilidad, no de suerte.'] },
        { h: '2. El torneo', li: ['La entrada es gratuita. Sin cuota ni compra.', 'Conectas una clave API de solo lectura. AYILON lee solo capital, beneficio y volumen — no puede operar, transferir ni retirar.', 'Los rankings se calculan automáticamente en tres categorías (rentabilidad %, beneficio, volumen) durante una temporada mensual que se reinicia el día 1 a las 00:00 UTC.', 'La tabla de rentabilidad % se ordena por rentabilidad ajustada al riesgo — penalizada por tu peor caída (drawdown) — para que una apuesta afortunada con alto apalancamiento no supere a un trader más constante.', 'Una cuenta por persona. Para optar a premios también debes operar en al menos el número publicado de días distintos y alcanzar el volumen mínimo de la temporada, de modo que los premios recompensen el trading real y sostenido, no una única apuesta a todo o nada.', 'Los depósitos y retiros durante una temporada se excluyen del rendimiento para mantener la equidad.'] },
        { h: '3. Premios', li: ['El bote se financia con las recompensas de trading de AYILON y crece con la liga. Cada premio es una parte real del bote — nunca más de lo financiado.', 'Los premios van a los mejores participantes elegibles de cada categoría al final de la temporada. Se permite ganar más de una categoría.', 'Los premios se pagan en USDT solo en la red TRON (TRC20), dentro de las 24 horas tras enviar el ganador una dirección válida. El ganador debe completar antes una breve entrevista; sin ella no se paga el premio.', 'Podemos ajustar el porcentaje financiado, el reparto, las categorías y el calendario, y retener premios ante sospecha de abuso.'] },
        { h: '4. Juego limpio y pérdida del premio', p: 'Lo siguiente conlleva la pérdida de elegibilidad y del premio; el abuso deliberado además acarrea descalificación y baneo permanente. Las decisiones de AYILON sobre elegibilidad y juego limpio son definitivas.', li: [
          'Operar varias cuentas para obtener ventaja, o que una persona controle varias inscripciones.',
          'Cobertura en sentido opuesto (largo/corto) entre cuentas vinculadas o relacionadas.',
          'Wash trading, autooperaciones o generar volumen artificial para inflar el ranking de volumen.',
          'Manipulación del mercado, o explotar errores, el sistema de puntuación o el mecanismo de premios.',
          'Falsear o tergiversar resultados, o rechazar una verificación razonable.',
          'Coludir con otros participantes, o compartir/operar una cuenta entre varias personas.',
          'Conectar una cuenta OKX no creada mediante el referido de AYILON — esas cuentas no pueden conectarse y nunca son elegibles.',
          'No cumplir los mínimos publicados (saldo, saldo superior del ranking de rentabilidad, volumen y días de trading) — no elegible.',
          'No completar la entrevista de ganador, o no enviar una wallet USDT (TRC20) válida dentro del plazo — el premio se pierde.',
          'Usar depósitos o retiros para manipular las métricas de rendimiento.',
          'Ser menor de 18 años, o participar desde una jurisdicción no permitida.'
        ] },
      ...
      vi: { t: 'Điều khoản dịch vụ & Luật giải đấu', u: 'Cập nhật lần cuối: 29/06/2026', intro: 'AYILON Arena ("AYILON", "chúng tôi") tổ chức một giải giao dịch toàn cầu, nơi người tham gia thi đấu bằng tài khoản sàn thực của mình. Bằng việc tạo tài khoản hoặc tham gia, bạn đồng ý với các Điều khoản này.', sec: [
        { h: '1. Điều kiện tham gia', li: ['Bạn phải từ 18 tuổi trở lên và được phép giao dịch phái sinh crypto theo pháp luật nơi bạn ở.', 'Tham gia cần email đã xác minh và một khóa API chỉ đọc được kết nối.', 'Để đủ điều kiện nhận thưởng, tài khoản sàn của bạn phải (a) đăng ký qua liên kết giới thiệu của AYILON, và (b) có số dư tối thiểu công bố khi mùa giải bắt đầu.', 'Hạng mục lợi nhuận (%) yêu cầu số dư tối thiểu cao hơn hạng mục tiền lãi và khối lượng, để tài khoản nhỏ không thể dùng lệnh all-in đòn bẩy cao nhằm thao túng bảng xếp hạng phần trăm — giữ đây là cuộc thi kỹ năng, không phải may rủi.'] },
        { h: '2. Giải đấu', li: ['Tham gia miễn phí. Không phí, không cần mua.', 'Bạn kết nối khóa API chỉ đọc. AYILON chỉ đọc tài sản, lợi nhuận và khối lượng — không thể giao dịch, chuyển hay rút.', 'Xếp hạng được tính tự động theo ba hạng mục (lợi nhuận %, tiền lãi, khối lượng) trong một mùa giải hàng tháng, đặt lại vào ngày 1 lúc 00:00 UTC.', 'Bảng lợi nhuận % được xếp theo lợi nhuận điều chỉnh rủi ro — bị trừ điểm theo mức sụt giảm (drawdown) lớn nhất — nên một ván cược đòn bẩy cao ăn may không thể vượt qua trader ổn định hơn.', 'Mỗi người một tài khoản. Để đủ điều kiện nhận thưởng, bạn còn phải giao dịch ít nhất số ngày riêng biệt đã công bố và đạt khối lượng tối thiểu của mùa — phần thưởng dành cho giao dịch thực sự, bền bỉ, không phải một ván tất tay.', 'Nạp và rút trong mùa giải bị loại khỏi thành tích để đảm bảo công bằng.'] },
        { h: '3. Giải thưởng', li: ['Quỹ thưởng đến từ phần thưởng giao dịch của AYILON và tăng theo quy mô giải. Mỗi giải là một phần thực tế của quỹ — không bao giờ vượt số đã cấp.', 'Giải thưởng trao cho những người đủ điều kiện đứng đầu mỗi hạng mục khi kết thúc mùa. Được phép thắng nhiều hạng mục.', 'Giải thưởng chỉ trả bằng USDT trên mạng TRON (TRC20), trong vòng 24 giờ sau khi người thắng gửi địa chỉ ví hợp lệ. Người thắng phải hoàn thành bài phỏng vấn ngắn trước; không có sẽ không được trả thưởng.', 'Chúng tôi có thể điều chỉnh tỷ lệ cấp quỹ, cách chia, hạng mục và lịch, và có thể giữ lại giải khi nghi ngờ gian lận.'] },
        { h: '4. Chơi công bằng & tịch thu giải', p: 'Những điều sau khiến mất tư cách nhận thưởng và bị tịch thu giải; gian lận cố ý còn bị loại tư cách và cấm vĩnh viễn. Quyết định của AYILON về điều kiện và công bằng là cuối cùng.', li: [
          'Dùng nhiều tài khoản để trục lợi, hoặc một người điều khiển nhiều lượt tham gia.',
          'Phòng hộ ngược chiều (long/short) giữa các tài khoản liên kết hoặc liên quan.',
          'Wash trading, tự khớp lệnh, hoặc tạo khối lượng giả để thao túng bảng khối lượng.',
          'Thao túng thị trường, hoặc khai thác lỗi, hệ thống tính điểm hay cơ chế giải thưởng.',
          'Làm giả hoặc khai sai kết quả, hoặc từ chối xác minh hợp lý.',
          'Thông đồng với người khác, hoặc chia sẻ/vận hành một tài khoản bởi nhiều người.',
          'Kết nối tài khoản OKX không tạo qua giới thiệu AYILON — các tài khoản này không thể kết nối và không bao giờ đủ điều kiện nhận thưởng.',
          'Không đạt mức tối thiểu công bố (số dư, số dư cao hơn của bảng lợi nhuận, khối lượng, số ngày giao dịch) — không đủ điều kiện.',
          'Không hoàn thành phỏng vấn người thắng, hoặc không gửi ví USDT (TRC20) hợp lệ trong thời hạn — mất giải.',
          'Dùng nạp hoặc rút để thao túng chỉ số thành tích.',
          'Dưới 18 tuổi, hoặc tham gia từ khu vực không được phép.'
        ] },
      ...
      ru: { t: 'Условия использования и правила турнира', u: 'Последнее обновление: 29 июня 2026', intro: 'AYILON Arena («AYILON», «мы») проводит глобальный торговый турнир, где участники соревнуются на своих реальных биржевых счетах. Создавая аккаунт или участвуя, вы соглашаетесь с этими Условиями.', sec: [
        { h: '1. Право на участие', li: ['Вам должно быть не менее 18 лет и вы должны иметь право торговать крипто-деривативами в своей юрисдикции.', 'Для участия нужны подтверждённая почта и подключённый ключ API «только чтение».', 'Для права на призы ваш биржевой счёт должен (a) быть зарегистрирован по реферальной ссылке AYILON и (b) иметь не менее опубликованного минимального баланса на старте сезона.', 'Категория доходности (%) требует более высокого минимального баланса, чем категории прибыли и объёма, чтобы маленькие счета не могли ставками ва-банк с высоким плечом накручивать процентный рейтинг — это делает её состязанием мастерства, а не удачи.'] },
        { h: '2. Турнир', li: ['Участие бесплатно. Без взносов и покупок.', 'Вы подключаете ключ «только чтение». AYILON читает только капитал, прибыль и объём — не может торговать, переводить или выводить.', 'Рейтинги считаются автоматически по трём категориям (доходность %, прибыль, объём) в месячном сезоне, который сбрасывается 1-го числа в 00:00 UTC.', 'Таблица доходности ранжируется по доходности с поправкой на риск — со штрафом за максимальную просадку — чтобы удачная ставка с высоким плечом не обошла более стабильного трейдера.', 'Один аккаунт на человека. Для права на приз также нужно торговать не менее опубликованного числа отдельных дней и достичь минимального объёма сезона — призы за реальную, устойчивую торговлю, а не за одну ставку ва-банк.', 'Пополнения и выводы в течение сезона исключаются из результата для честности.'] },
        { h: '3. Призы', li: ['Призовой фонд формируется из торговых вознаграждений AYILON и растёт вместе с лигой. Каждый приз — реальная доля фонда, никогда не больше профинансированной суммы.', 'Призы получают лучшие подходящие участники в каждой категории в конце сезона. Победа в нескольких категориях разрешена.', 'Призы выплачиваются в USDT только в сети TRON (TRC20) в течение 24 часов после того, как победитель отправит корректный адрес кошелька. Победитель должен сначала пройти короткое интервью; без него приз не выплачивается.', 'Мы можем менять процент финансирования, распределение, категории и расписание и удерживать призы при подозрении в злоупотреблении.'] },
        { h: '4. Честная игра и лишение приза', p: 'Следующее ведёт к потере права на приз и его аннулированию; умышленные злоупотребления также ведут к дисквалификации и вечной блокировке. Решения AYILON по праву на участие и честной игре окончательны.', li: [
          'Несколько аккаунтов ради преимущества или управление несколькими заявками одним человеком.',
          'Встречный (long/short) хедж между связанными или родственными аккаунтами.',
          'Wash-trading, самосделки или иное создание искусственного объёма для накрутки таблицы объёма.',
          'Манипуляции рынком либо эксплуатация багов, системы подсчёта или призового механизма.',
          'Фальсификация или искажение результатов либо отказ от разумной проверки.',
          'Сговор с другими участниками или использование одного аккаунта несколькими людьми.',
          'Подключение аккаунта OKX, созданного не по реферальной ссылке AYILON — такие аккаунты нельзя подключить, и они никогда не претендуют на приз.',
          'Несоответствие опубликованным минимумам (баланс, повышенный баланс для таблицы доходности, объём, дни торговли) — нет права на приз.',
          'Непрохождение интервью победителя или неотправка корректного кошелька USDT (TRC20) в срок — приз аннулируется.',
          'Использование вводов/выводов для манипуляции показателями результата.',
          'Возраст младше 18 лет или участие из юрисдикции, где это не разрешено.'
        ] },
    ...
    about: {
      en: { t: 'About — AYILON Arena', h1: 'Prove your edge.<br><b>Compete</b> for the prize.', intro: 'AYILON Arena is a global real-money trading league. Traders worldwide compete on their own exchange accounts — and the best rise to the top of the board.', sec: [
        ...
        { h: 'Three categories', p: 'Compete on return %, profit and volume in a monthly season that resets on the 1st. The return board is ranked by risk-adjusted return, so consistency beats a lucky gamble. Miss one board, still win another.' },
        ...
        { h: 'FAQ', faq: [ { q: 'Is it free to join?', a: 'Yes — free entry, no fee. You connect a read-only key and your funds never leave your own exchange account.' }, { q: 'Is my money safe? Can AYILON touch it?', a: 'No. The API key is read-only — we can only read your stats, never trade, transfer, or withdraw.' }, { q: 'How do I win a prize?', a: 'Finish at the top of a category when the season ends. You must have signed up via the AYILON referral link and hold the minimum balance.' }, { q: 'When do seasons start and end?', a: 'A new monthly season resets on the 1st at 00:00 UTC. The return board is ranked by risk-adjusted return, so steady skill beats a lucky gamble.' }, { q: 'What is not allowed?', a: 'Multiple accounts, opposite-side hedging, and wash trading lead to disqualification and a permanent ban.' }, { q: 'How do I contact support?', a: 'Email ' + mail + '.' } ] },
      ...
      ko: { t: '소개 — AYILON Arena', h1: '실력을 증명하고,<br><b>상금</b>에 도전하세요.', intro: 'AYILON Arena는 글로벌 실전 트레이딩 리그입니다. 전 세계 트레이더가 자신의 거래소 계정으로 경쟁하고, 최고가 리더보드 상단에 오릅니다.', sec: [
        ...
        { h: '세 가지 부문', p: '수익률·수익금·거래량 세 부문으로 매월 1일 초기화되는 월간 시즌에서 경쟁합니다. 수익률 부문은 위험조정 수익률로 순위를 매겨 운빨 도박보다 꾸준함이 이깁니다. 한 부문을 놓쳐도 다른 부문에서 우승할 수 있습니다.' },
        { h: '안전한 이유', p: '참가는 무료이며 읽기 전용 키만 연결합니다. AYILON은 통계만 읽을 뿐 매매·이체·출금을 할 수 없습니다. 자금은 처음부터 끝까지 당신의 거래소 계정에 그대로 있습니다.' },
        { h: '자주 묻는 질문', faq: [ { q: '참가는 무료인가요?', a: '네, 무료입니다. 참가비 없고, 읽기 전용 키만 연결하며 자금은 당신의 거래소 계좌를 절대 떠나지 않습니다.' }, { q: '제 자금은 안전한가요? AYILON이 건드릴 수 있나요?', a: '아니요. API 키는 읽기 전용이라 통계만 읽을 뿐, 매매·이체·출금은 불가능합니다.' }, { q: '상금은 어떻게 받나요?', a: '시즌 종료 시 부문 상위에 들면 됩니다. AYILON 추천 링크로 가입했고 최소 잔고를 보유해야 자격이 됩니다.' }, { q: '시즌은 언제 시작·종료되나요?', a: '월간 시즌은 매월 1일 00:00 UTC에 초기화됩니다. 수익률 부문은 위험조정 수익률로 순위를 매겨 꾸준함이 운빨 도박을 이깁니다.' }, { q: '금지 행위는 무엇인가요?', a: '다중 계정, 양방향 헤지, 워시 트레이딩은 실격 및 영구 정지 사유입니다.' }, { q: '문의는 어떻게 하나요?', a: '이메일: ' + mail } ] },
      ...
      zh: { t: '关于 — AYILON Arena', h1: '证明你的实力，<br><b>争夺</b>奖金。', intro: 'AYILON Arena 是全球真金交易联赛。世界各地的交易者用自己的交易所账户竞争——最强者登顶排行榜。', sec: [
        ...
        { h: '三个类别', p: '在收益率、盈利额和交易量上竞争，每月1日重置的月度赛季。收益率榜按风险调整后收益排名，稳健胜过运气式豪赌。错过一个榜，仍可赢另一个。' },
        { h: '为何安全', p: '免费参赛，你连接的是只读密钥——AYILON只读取数据，永远无法交易、转账或提现。你的资金始终留在你自己的交易所账户中。' },
        { h: '常见问题', faq: [ { q: '参加免费吗？', a: '免费。无报名费，只需连接只读密钥，资金始终留在你自己的交易所账户。' }, { q: '我的资金安全吗？AYILON 能动吗？', a: '不能。API 密钥为只读——我们只能读取数据，无法交易、转账或提现。' }, { q: '如何获得奖金？', a: '赛季结束时进入某类别前列即可。须通过 AYILON 推荐链接注册并持有最低余额。' }, { q: '赛季何时开始和结束？', a: '月度赛季每月 1 日 00:00 UTC 重置。收益率榜按风险调整后收益排名，稳健胜过运气式豪赌。' }, { q: '哪些行为被禁止？', a: '多账号、反向对冲、刷量都会导致取消资格并永久封禁。' }, { q: '如何联系客服？', a: '邮箱：' + mail } ] },
      ...
      es: { t: 'Acerca de — AYILON Arena', h1: 'Demuestra tu ventaja.<br><b>Compite</b> por el premio.', intro: 'AYILON Arena es una liga global de trading con dinero real. Traders de todo el mundo compiten con sus propias cuentas — y los mejores llegan a lo más alto.', sec: [
        ...
        { h: 'Tres categorías', p: 'Compite en rentabilidad %, beneficio y volumen en una temporada mensual que se reinicia el día 1. La tabla de rentabilidad se ordena por rentabilidad ajustada al riesgo, así la constancia gana a la apuesta afortunada. Si fallas en una, aún puedes ganar otra.' },
      ...
      vi: { t: 'Giới thiệu — AYILON Arena', h1: 'Chứng minh bản lĩnh.<br><b>Tranh</b> giải thưởng.', intro: 'AYILON Arena là giải giao dịch tiền thật toàn cầu. Trader khắp thế giới thi đấu bằng tài khoản sàn của mình — người giỏi nhất lên đỉnh bảng.', sec: [
        ...
        { h: 'Ba hạng mục', p: 'Thi đấu ở lợi nhuận %, tiền lãi và khối lượng trong một mùa giải hàng tháng, đặt lại vào ngày 1. Bảng lợi nhuận xếp theo lợi nhuận điều chỉnh rủi ro, nên sự ổn định thắng ván cược ăn may. Lỡ một bảng vẫn thắng bảng khác.' },
      ...
      ru: { t: 'О нас — AYILON Arena', h1: 'Докажи мастерство.<br><b>Борись</b> за приз.', intro: 'AYILON Arena — глобальная лига трейдинга на реальные деньги. Трейдеры со всего мира соревнуются на своих биржевых счетах, и лучшие поднимаются на вершину.', sec: [
        ...
        { h: 'Три категории', p: 'Соревнуйтесь в доходности %, прибыли и объёме в месячном сезоне, который сбрасывается 1-го числа. Таблица доходности ранжируется с поправкой на риск, поэтому стабильность важнее удачной ставки. Пропустили одну — выиграете другую.' },
