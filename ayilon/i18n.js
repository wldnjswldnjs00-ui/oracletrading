...
(function () {
  ...
  var T = {
    en: {
      ...
      'db.nav.dashboard':    'Dashboard',
      'db.nav.terminal':     'Terminal',
      'db.nav.bots':         'Signal Bots',
      'db.nav.subscription': 'Subscription',
      'db.nav.settings':     'Settings',
      'db.nav.guide':        'Guide',
      'db.nav.logout':       'Log out',
      'db.set.profile':      'Profile',
      'db.set.apikey':       'OKX API Key',
      'db.set.security':     'Security (2FA)',
      'db.set.telegram':     'Telegram Alerts',
      'db.set.email_alerts': 'Email Alerts',
      'db.set.language':     'Language',
      'db.set.danger':       'Danger Zone',
      'db.set.save':         'Save Changes',
      'db.set.api_connect':  'Connect API Key →',
      'db.set.api_disconnect': 'Disconnect',
      'db.set.del_acct':     'Delete Account',
      'db.set.email_verify': 'Send Code',
      'db.set.email_confirm':'Confirm Change',
      'db.set.code_ph':      'Enter 6-digit code',
      'db.term.api_register':'Register API Key',
      'db.term.api_msg':     'Register your API key to enable trading',
    ...
    ko: {
      ...
      '404.dash':  '대시보드로',
      /* ── DASHBOARD NAV & SETTINGS ── */
      'db.nav.dashboard':    '대시보드',
      'db.nav.terminal':     '수동 터미널',
      'db.nav.bots':         '시그널 봇',
      'db.nav.subscription': '구독',
      'db.nav.settings':     '설정',
      'db.nav.guide':        '사용 가이드',
      'db.nav.logout':       '로그아웃',
      'db.set.profile':      '프로필',
      'db.set.apikey':       'OKX API 키',
      'db.set.security':     '보안 (2FA)',
      'db.set.telegram':     '텔레그램 알림',
      'db.set.email_alerts': '이메일 알림',
      'db.set.language':     '언어 / Language',
      'db.set.danger':       '위험 영역',
      'db.set.save':         '변경사항 저장',
      'db.set.api_connect':  'API 키 연결하기 →',
      'db.set.api_disconnect': '연결 해제',
      'db.set.del_acct':     '계정 삭제',
      'db.set.email_verify': '인증 코드 전송',
      'db.set.email_confirm':'변경 확인',
      'db.set.code_ph':      '6자리 코드 입력',
      'db.term.api_register':'API 키 등록',
      'db.term.api_msg':     'API 키를 등록하면 거래할 수 있습니다',
