...
(function () {
  ...
  var T = {
    en: {
      ...
      'db.sub.starter_desc':  'Start with basic automated trading',
      'db.sub.starter.f1':    '2 signal bots',
      'db.sub.starter.f2':    'OKX integration',
      'db.sub.starter.f3':    'Basic strategies (SR Bounce, RSI DCA)',
      'db.sub.starter.f4':    'Email notifications',
      'db.sub.pro_desc':      'Plan for professional traders',
      'db.sub.pro.f1':        '5 signal bots',
      'db.sub.pro.f2':        'All Starter features',
      'db.sub.pro.f3':        'Pro strategies (MA Crossover, BB Reversion, Breakout, MA Ribbon)',
      'db.sub.pro.f4':        'Telegram notifications',
      'db.sub.pro.f5':        'Priority support',
      'db.sub.elite_desc':    'Unlimited bots and all strategies',
      'db.sub.elite.f1':      'Unlimited bots',
      'db.sub.elite.f2':      'All Pro features',
      'db.sub.elite.f3':      'Elite strategies (MACD Divergence, Funding Rate, ATR Trend)',
      'db.sub.elite.f4':      'Dedicated support',
    ...
    ko: {
      ...
      'db.sub.starter_desc':  '기본 자동 거래 시작',
      'db.sub.starter.f1':    '시그널 봇 2개',
      'db.sub.starter.f2':    'OKX 연동',
      'db.sub.starter.f3':    '기본 전략 (SR Bounce, RSI DCA)',
      'db.sub.starter.f4':    '이메일 알림',
      'db.sub.pro_desc':      '전문 트레이더를 위한 플랜',
      'db.sub.pro.f1':        '시그널 봇 5개',
      'db.sub.pro.f2':        'Starter 모든 기능',
      'db.sub.pro.f3':        'Pro 전략 (MA Crossover, BB Reversion, Breakout, MA Ribbon)',
      'db.sub.pro.f4':        '텔레그램 알림',
      'db.sub.pro.f5':        '우선 지원',
      'db.sub.elite_desc':    '무제한 봇과 모든 전략',
      'db.sub.elite.f1':      '무제한 봇',
      'db.sub.elite.f2':      'Pro 모든 기능',
      'db.sub.elite.f3':      'Elite 전략 (MACD Divergence, Funding Rate, ATR Trend)',
      'db.sub.elite.f4':      '전담 지원',
