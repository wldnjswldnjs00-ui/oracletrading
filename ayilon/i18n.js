...
(function () {
  ...
  var T = {
    en: {
      ...
      'db.2fa.enable':          'Enable',
      'db.2fa.disable':         'Disable',
      'db.2fa.enabled':         '✓ Enabled',
      'db.2fa.enabled_success': '✓ 2FA enabled successfully',
      'db.2fa.disabled_success':'2FA disabled',
      'db.2fa.invalid_code':    'Invalid code. Please try again.',
      'db.2fa.enter_6_digits':  'Please enter a 6-digit code.',
      'db.2fa.verify_enable':   'Verify & Enable',
      'db.2fa.confirm_disable': 'Confirm Disable',
      'db.2fa.totp_secret_label':'Or enter this code manually in your app:',
      'db.2fa.enter_code_confirm':'Enter the 6-digit code shown in the app:',
      'db.2fa.enter_code_disable':'Enter your current Authenticator code:',
      'db.2fa.email_code_sent': 'Enter the 6-digit code sent to your email:',
      'db.2fa.both_tip':        '✓ Both Email and Authenticator are active — your account is well-protected.',
      ...
      'db.set.saving':       'Saving...',
      'db.set.saved':        '✓ Saved',
      'db.set.save_fail':    'Failed to save',
      'db.set.error':        'An error occurred. Please try again.',
      ...
      'db.set.tg_help_2':    '② Send <code>/start</code> to your bot, then visit <code>https://api.telegram.org/bot&lt;TOKEN&gt;/getUpdates</code> in a browser → the <code>chat.id</code> value is your Chat ID',
      'db.set.tg_help_3':    'See the Usage Guide → "Telegram Alerts Setup Guide" for full instructions.',
      'db.set.tg_test':      'Send Test',
      'db.set.tg_test_ok':   '✓ Test message sent to Telegram!',
      'db.set.tg_test_fail': '✗ Failed to send. Check your Bot Token and Chat ID.',
      'db.set.tg_fill_first':'Please enter Bot Token and Chat ID first.',
      'db.set.change_pass':   'Change Password',
      'db.set.change_pass_btn':'Change Password',
      'db.set.current_pass':  'Current Password',
      'db.set.new_pass':      'New Password',
      'db.set.confirm_pass':  'Confirm New Password',
      'db.set.pass_changed':  '✓ Password changed successfully',
      'db.set.pass_too_short':'Password must be at least 8 characters',
      'db.set.pass_mismatch': 'Passwords do not match',
      'db.set.wrong_current_pass': 'Current password is incorrect',
      'db.set.fill_all':      'Please fill in all fields',
      'db.term.api_register':'Register API Key',
      'db.term.api_msg':     'Register your API key to enable trading',
      'db.term.load_more':   'Load More',
      'db.title':            'Dashboard',
      ...
      'db.no_api_account':    'No API accounts registered',
      'db.portfolio.change':  'Portfolio Change',
      'db.no_api_desc':       'Register your OKX API key to start real-time portfolio tracking and bot trading.',
      'db.add_first_api':     '+ Add First API Account',
      'db.tab.positions':     'Positions',
      'db.tab.orders':        'Pending Orders',
      'db.tab.history':       'Trade History',
      'db.tab.account':       'Account',
      'db.term.ready':        'Trading ready. Start bot setup.',
      'db.term.quickinfo':    'Quick Info',
      'db.term.funding':      'Funding Rate',
      'db.term.volume':       '24h Volume',
      'db.term.change':       '24h Change',
      'db.bots.select_strategy': 'Select Strategy',
      'db.bots.create_bot':   'Create Signal Bot',
      'db.bots.guide_desc':   'Follow the steps below to set up your first signal bot.',
      'db.bots.step1':        '<strong style="color:#fff;">Select Strategy</strong> — Choose from the list on the left',
      'db.bots.step2':        '<strong style="color:#fff;">Select API Account</strong> — Choose your connected OKX account',
      'db.bots.step3':        '<strong style="color:#fff;">Set Parameters</strong> — Adjust leverage, position size, and risk',
      'db.bots.step4':        '<strong style="color:#fff;">Start Bot</strong> — Review settings and start the bot',
      'db.bots.start_btn':    '+ Start Bot',
      'db.refresh':           '↻ Refresh',
      'db.sub.current_plan':  'Current Plan',
      'db.sub.starter_desc':  'BTC & ETH automated trading',
      'db.sub.starter.f1':    '1 trend-following bot',
      'db.sub.starter.f2':    'BTC & ETH trading',
      'db.sub.starter.f3':    'OKX integration · demo/live',
      'db.sub.starter.f4':    'Email notifications',
      'db.sub.elite_desc':    'All symbols + everything',
      'db.sub.elite.f1':      'Trade all OKX symbols',
      'db.sub.elite.f2':      'All Starter features',
      'db.sub.elite.f3':      'Telegram notifications',
      'db.sub.elite.f4':      'Priority support',
      'db.sub.elite.f5':      'Free with referral signup',
      'db.sub.ref.badge':     'BEST VALUE',
      'db.sub.ref.title':     'Sign up via referral → Elite free forever',
      'db.sub.ref.desc':      'Join OKX through the link below and use Elite (all symbols) free forever. The bot only runs on that referral account. Already have an OKX account? Use a paid plan below.',
      'db.sub.ref.cta':       'Start free via referral →',
      'db.bots.daily_loss':      'Daily Loss Limit (%)',
      'db.bots.daily_loss_hint': 'Bot pauses for the day if cumulative loss reaches this.',
      'db.bots.symbol':          'Trading Pair',
      'db.bots.selected':        'Selected',
      'db.sub.payment_method':'Payment Method',
      'db.sub.payment_desc':  'Payments accepted in <strong style="color:#fff;">USDT TRC-20</strong> only. Send the exact amount to the address below, then contact the admin.',
      'db.sub.deposit_addr':  'USDT TRC-20 Deposit Address',
      'db.sub.pay_step1':     '1. Select a subscription plan',
      'db.sub.pay_step2':     '2. Send the amount to the TRC-20 address',
      'db.sub.pay_step3':     '3. Send the transaction ID via <a href="mailto:wldnjswldnjs00@gmail.com" style="color:var(--yellow);text-decoration:none;">email to admin</a>',
      'db.sub.pay_step4':     '4. Plan will be activated within 24 hours after confirmation',
      'db.api.desc':          'Connect your OKX API key to enable live trading. Generate your key with <strong style="color:#fff;">trade-only</strong> permissions — never enable withdrawal permissions.',
      'db.api.key_ph':        'Paste your OKX API key',
      'db.api.secret_ph':     'Paste your secret key',
      'db.api.pass_ph':       'API passphrase',
      'db.api.connected':     'OKX — Connected',
      'db.api.encrypted_note':'API key is stored securely encrypted. To change, disconnect and enter a new key.',
      'db.2fa.email_desc':    'A 6-digit code will be sent to your email at login',
      'db.save':              'Save',
      'db.email.alerts_title':'Receive Email Alerts',
      'db.email.alerts_desc': 'Receive trade execution, stop-loss, and daily report emails',
      'db.del.title':         'Delete Account',
      'db.del.desc':          'Permanently delete your account. This action cannot be undone.',
      'db.guide.search_ph':   'Search guides...',
      'db.guide.all':         'All',
      'db.guide.notice':      'Notices',
      'db.guide.tutorial':    'Tutorials',
      'db.guide.no_results':  'No results found',
      'db.upgrade.exact_title':'⚠️ Send the exact amount including decimals',
      'db.upgrade.exact_desc': 'If the amount differs, automatic detection will fail.',
      'db.upgrade.amount_label':'Amount to Send (USDT TRC-20)',
      'db.copy':              'Copy',
      'db.upgrade.addr_label': 'Deposit Address (USDT TRC-20)',
      'db.upgrade.detecting': 'Detecting deposit automatically... (approx. 1 minute)',
      'db.upgrade.txid_label': 'Enter Transaction ID manually (optional)',
      'db.upgrade.txid_ph':   'TxID / Transaction Hash',
      'db.confirm':           'Confirm',
      'db.close':             'Close',
      'db.2fa.code_label':    'Verification Code',
      'db.cancel':            'Cancel',
      ...
      'db.term.no_api_pos':   'Connect API key to view positions',
      'db.term.no_positions': 'No open positions',
      'db.term.no_api_orders':'Connect API key to view orders',
      'db.term.no_orders':    'No pending orders',
      'db.term.no_api_history':'Connect API key to view trade history',
      'db.term.no_history':   'No trade history',
      'db.term.no_api_account':'Connect API key to view account info',
      'db.term.account_error':'Could not load account info',
      'db.term.load_fail':    'Load failed',
      'db.term.symbol':       'Symbol',
      'db.term.direction':    'Position',
      'db.term.qty':          'Size',
      'db.term.entry_price':  'Entry',
      'db.term.mark_price':   'Mark',
      'db.term.unreal_pnl':   'Unreal PnL',
      'db.term.roe':          'ROE',
      'db.term.ord_type':     'Type',
      'db.term.price':        'Price',
      'db.term.status':       'Status',
      'db.term.time':         'Time',
      'db.term.fee':          'Fee',
    ...
    ko: {
      ...
      'db.2fa.disable':         '비활성화',
      'db.2fa.enabled':         '✓ 활성화됨',
      'db.2fa.enabled_success': '✓ 2FA가 성공적으로 활성화되었습니다',
      'db.2fa.disabled_success':'2FA가 비활성화되었습니다',
      'db.2fa.invalid_code':    '잘못된 코드입니다. 다시 시도하세요.',
      'db.2fa.enter_6_digits':  '6자리 코드를 입력하세요.',
      'db.2fa.verify_enable':   '인증 및 활성화',
      'db.2fa.confirm_disable': '비활성화 확인',
      'db.2fa.totp_secret_label':'또는 아래 코드를 앱에 직접 입력:',
      'db.2fa.enter_code_confirm':'앱에 표시된 6자리 코드를 입력하세요:',
      'db.2fa.enter_code_disable':'현재 Authenticator 앱 코드를 입력하세요:',
      'db.2fa.email_code_sent': '이메일로 전송된 6자리 코드를 입력하세요:',
      'db.2fa.both_tip':        '✓ 이메일과 Authenticator 두 가지 모두 활성화되어 계정이 안전하게 보호됩니다.',
      ...
      'db.set.saving':       '저장 중...',
      'db.set.saved':        '✓ 저장되었습니다',
      'db.set.save_fail':    '저장에 실패했습니다',
      'db.set.error':        '오류가 발생했습니다. 다시 시도하세요.',
      ...
      'db.set.tg_help_2':    '② 봇에게 <code>/start</code> 전송 후 브라우저에서 <code>https://api.telegram.org/bot&lt;TOKEN&gt;/getUpdates</code> 접속 → <code>chat.id</code> 값이 Chat ID',
      'db.set.tg_help_3':    '자세한 방법은 사용 가이드 → "텔레그램 알림 설정 가이드"를 참고하세요.',
      'db.set.tg_test':      '테스트 전송',
      'db.set.tg_test_ok':   '✓ 텔레그램으로 테스트 메시지를 전송했습니다!',
      'db.set.tg_test_fail': '✗ 전송 실패. Bot Token과 Chat ID를 확인하세요.',
      'db.set.tg_fill_first':'Bot Token과 Chat ID를 먼저 입력하세요.',
      'db.set.change_pass':   '비밀번호 변경',
      'db.set.change_pass_btn':'비밀번호 변경',
      'db.set.current_pass':  '현재 비밀번호',
      'db.set.new_pass':      '새 비밀번호',
      'db.set.confirm_pass':  '새 비밀번호 확인',
      'db.set.pass_changed':  '✓ 비밀번호가 변경되었습니다',
      'db.set.pass_too_short':'비밀번호는 8자 이상이어야 합니다',
      'db.set.pass_mismatch': '비밀번호가 일치하지 않습니다',
      'db.set.wrong_current_pass': '현재 비밀번호가 올바르지 않습니다',
      'db.set.fill_all':      '모든 항목을 입력해 주세요',
      'db.term.api_register':'API 키 등록',
      'db.term.api_msg':     'API 키를 등록하면 거래할 수 있습니다',
      'db.term.load_more':   '더 보기',
      'db.title':            '대시보드',
      ...
      'db.no_api_account':    '등록된 API 계정이 없습니다',
      'db.portfolio.change':  '포트폴리오 변화',
      'db.no_api_desc':       'OKX API 키를 등록하면 실시간 포트폴리오와 봇 거래를 시작할 수 있습니다.',
      'db.add_first_api':     '+ 첫 API 계정 만들기',
      'db.tab.positions':     '포지션',
      'db.tab.orders':        '대기주문',
      'db.tab.history':       '거래내역',
      'db.tab.account':       '계좌',
      'db.term.ready':        '거래 준비 완료. 봇 설정을 시작하세요.',
      'db.term.quickinfo':    '빠른 정보',
      'db.term.funding':      '펀딩비',
      'db.term.volume':       '24h 거래량',
      'db.term.change':       '24h 변동',
      'db.bots.select_strategy': '전략 선택',
      'db.bots.create_bot':   '시그널 봇 생성',
      'db.bots.guide_desc':   '아래 단계에 따라 첫 번째 시그널 봇을 설정하세요.',
      'db.bots.step1':        '<strong style="color:#fff;">전략 선택</strong> — 왼쪽 목록에서 원하는 전략을 선택하세요',
      'db.bots.step2':        '<strong style="color:#fff;">API 계정 선택</strong> — 연결된 OKX 계정을 선택하세요',
      'db.bots.step3':        '<strong style="color:#fff;">파라미터 설정</strong> — 레버리지, 포지션 크기, 리스크를 조정하세요',
      'db.bots.step4':        '<strong style="color:#fff;">봇 시작</strong> — 설정을 확인하고 봇을 시작하세요',
      'db.bots.start_btn':    '+ 봇 시작하기',
      'db.refresh':           '↻ 새로고침',
      'db.sub.current_plan':  '현재 플랜',
      'db.sub.starter_desc':  'BTC·ETH 자동 거래',
      'db.sub.starter.f1':    '추세추종 봇 1개',
      'db.sub.starter.f2':    'BTC · ETH 거래',
      'db.sub.starter.f3':    'OKX 연동 · 데모/라이브',
      'db.sub.starter.f4':    '이메일 알림',
      'db.sub.elite_desc':    '전 종목 + 모든 기능',
      'db.sub.elite.f1':      '전 OKX 종목 거래',
      'db.sub.elite.f2':      'Starter 모든 기능',
      'db.sub.elite.f3':      '텔레그램 알림',
      'db.sub.elite.f4':      '우선 지원',
      'db.sub.elite.f5':      '리퍼럴 가입 시 무료',
      'db.sub.ref.badge':     '최고 혜택',
      'db.sub.ref.title':     '리퍼럴로 가입 → Elite 영구 무료',
      'db.sub.ref.desc':      '아래 링크로 OKX에 가입하면 Elite(전 종목)를 영구 무료로 사용합니다. 봇은 해당 리퍼럴 계정에서만 작동합니다. 이미 OKX 계정이 있다면 아래 유료 플랜을 이용하세요.',
      'db.sub.ref.cta':       '리퍼럴로 무료 시작 →',
      'db.bots.daily_loss':      '일일 손실 한도 (%)',
      'db.bots.daily_loss_hint': '하루 누적 손실이 이만큼이면 봇을 그날 정지합니다.',
      'db.bots.symbol':          'Trading Pair',
      'db.bots.selected':        '선택됨',
      'db.sub.payment_method':'결제 방법',
      'db.sub.payment_desc':  '결제는 <strong style="color:#fff;">USDT TRC-20</strong>으로만 받습니다. 아래 주소로 정확한 금액을 전송한 후 관리자에게 연락해 주세요.',
      'db.sub.deposit_addr':  'USDT TRC-20 입금 주소',
      'db.sub.pay_step1':     '1. 구독 플랜을 선택하세요',
      'db.sub.pay_step2':     '2. 해당 금액을 TRC-20 주소로 전송하세요',
      'db.sub.pay_step3':     '3. 트랜잭션 ID를 <a href="mailto:wldnjswldnjs00@gmail.com" style="color:var(--yellow);text-decoration:none;">관리자에게 이메일</a>로 보내세요',
      'db.sub.pay_step4':     '4. 확인 후 24시간 이내 플랜이 활성화됩니다',
      'db.api.desc':          'OKX API 키를 연결하여 실시간 거래를 활성화하세요. <strong style="color:#fff;">거래 전용</strong> 권한으로 키를 생성하고 출금 권한은 절대 활성화하지 마세요.',
      'db.api.key_ph':        'OKX API 키를 붙여넣으세요',
      'db.api.secret_ph':     '시크릿 키를 붙여넣으세요',
      'db.api.pass_ph':       'API 패스프레이즈',
      'db.api.connected':     'OKX — 연결됨',
      'db.api.encrypted_note':'API 키는 안전하게 암호화 저장됩니다. 변경하려면 연결 해제 후 새 키를 입력하세요.',
      'db.2fa.email_desc':    '로그인 시 이메일로 6자리 코드 전송',
      'db.save':              '저장',
      'db.email.alerts_title':'이메일 알림 수신',
      'db.email.alerts_desc': '거래 실행, 손절, 일일 리포트를 이메일로 받습니다',
      'db.del.title':         '계정 삭제',
      'db.del.desc':          '계정을 영구 삭제합니다. 이 작업은 되돌릴 수 없습니다.',
      'db.guide.search_ph':   '가이드 검색...',
      'db.guide.all':         '전체',
      'db.guide.notice':      '공지사항',
      'db.guide.tutorial':    '튜토리얼',
      'db.guide.no_results':  '검색 결과가 없습니다',
      'db.upgrade.exact_title':'⚠️ 소수점까지 정확한 금액을 전송하세요',
      'db.upgrade.exact_desc': '금액이 다르면 자동 감지가 되지 않습니다.',
      'db.upgrade.amount_label':'전송할 금액 (USDT TRC-20)',
      'db.copy':              '복사',
      'db.upgrade.addr_label': '입금 주소 (USDT TRC-20)',
      'db.upgrade.detecting': '입금 자동 감지 중... (약 1분 소요)',
      'db.upgrade.txid_label': '트랜잭션 ID 직접 입력 (선택)',
      'db.upgrade.txid_ph':   'TxID / 트랜잭션 해시',
      'db.confirm':           '확인',
      'db.close':             '닫기',
      'db.2fa.code_label':    '인증 코드',
      'db.cancel':            '취소',
      ...
      'db.term.no_api_pos':   'API 키를 연결하면 포지션이 표시됩니다',
      'db.term.no_positions': '열린 포지션이 없습니다',
      'db.term.no_api_orders':'API 키를 연결하면 주문이 표시됩니다',
      'db.term.no_orders':    '대기 중인 주문이 없습니다',
      'db.term.no_api_history':'API 키를 연결하면 거래내역이 표시됩니다',
      'db.term.no_history':   '거래 내역이 없습니다',
      'db.term.no_api_account':'API 키를 연결하면 계좌 정보가 표시됩니다',
      'db.term.account_error':'계좌 정보를 불러올 수 없습니다',
      'db.term.load_fail':    '불러오기 실패',
      'db.term.symbol':       '심볼',
      'db.term.direction':    '방향',
      'db.term.qty':          '수량',
      'db.term.entry_price':  '진입가',
      'db.term.mark_price':   '현재가',
      'db.term.unreal_pnl':   '미실현 손익',
      'db.term.roe':          'ROE',
      'db.term.ord_type':     '유형',
      'db.term.price':        '가격',
      'db.term.status':       '상태',
    ...
    zh: {
      ...
      'login.email':'邮箱','login.password':'密码','login.password.ph':'输入密码','login.show':'显示','login.submit':'登录','login.forgot':'忘记密码？','login.email.ph':'you@example.com',
      ...
      'signup.username':'用户名','signup.username.hint':'仅限字母和数字（2–9 个字符）','signup.name':'姓名','signup.pw':'密码','signup.pw.ph':'8 位以上，字母 + 数字 + 符号','signup.pw.hint':'使用字母、数字和特殊字符（8 位以上）','signup.pw2':'确认密码','signup.pw2.ph':'再次输入密码','signup.show':'显示','signup.name.ph':'张三','signup.username.ph':'例如 ayilon7','signup.email.ph':'you@example.com',
    ...
    es: {
      ...
      'login.email':'Correo','login.password':'Contraseña','login.password.ph':'Introduce tu contraseña','login.show':'Mostrar','login.submit':'Iniciar sesión','login.forgot':'¿Olvidaste tu contraseña?','login.email.ph':'tu@ejemplo.com',
      ...
      'signup.username':'Nombre de usuario','signup.username.hint':'Solo letras y números (2–9 caracteres)','signup.name':'Nombre completo','signup.pw':'Contraseña','signup.pw.ph':'8+ caracteres, letras + números + símbolos','signup.pw.hint':'Usa letras, números y caracteres especiales (8+)','signup.pw2':'Confirmar contraseña','signup.pw2.ph':'Vuelve a introducir tu contraseña','signup.show':'Mostrar','signup.name.ph':'Juan Pérez','signup.username.ph':'p. ej. ayilon7','signup.email.ph':'tu@ejemplo.com',
    ...
    vi: {
      ...
      'login.email':'Email','login.password':'Mật khẩu','login.password.ph':'Nhập mật khẩu','login.show':'Hiện','login.submit':'Đăng nhập','login.forgot':'Quên mật khẩu?','login.email.ph':'ban@vidu.com',
      ...
      'signup.username':'Tên người dùng','signup.username.hint':'Chỉ chữ và số (2–9 ký tự)','signup.name':'Họ và tên','signup.pw':'Mật khẩu','signup.pw.ph':'8+ ký tự, chữ + số + ký hiệu','signup.pw.hint':'Dùng chữ, số và ký tự đặc biệt (8+ ký tự)','signup.pw2':'Xác nhận mật khẩu','signup.pw2.ph':'Nhập lại mật khẩu','signup.show':'Hiện','signup.name.ph':'Nguyễn Văn A','signup.username.ph':'vd: ayilon7','signup.email.ph':'ban@vidu.com',
    ...
    ru: {
      ...
      'login.email':'Почта','login.password':'Пароль','login.password.ph':'Введите пароль','login.show':'Показать','login.submit':'Войти','login.forgot':'Забыли пароль?','login.email.ph':'you@example.com',
      ...
      'signup.username':'Имя пользователя','signup.username.hint':'Только буквы и цифры (2–9 символов)','signup.name':'Полное имя','signup.pw':'Пароль','signup.pw.ph':'8+ символов, буквы + цифры + символы','signup.pw.hint':'Используйте буквы, цифры и спецсимволы (8+)','signup.pw2':'Подтвердите пароль','signup.pw2.ph':'Повторите пароль','signup.show':'Показать','signup.name.ph':'Иван Иванов','signup.username.ph':'напр. ayilon7','signup.email.ph':'you@example.com',
